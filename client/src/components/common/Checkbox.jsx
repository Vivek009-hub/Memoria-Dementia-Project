  ...
  return (
    <label htmlFor={inputId} className={`flex items-start space-x-3.5 cursor-pointer touch-target py-1.5 ${className}`}>
      <input
        ...
        checked={checked}
        onChange={onChange}
        className="w-6 h-6 mt-0.5 rounded-lg border-2 border-slate-700 bg-slate-900 text-brand-600 focus:ring-brand-500 focus:ring-offset-slate-950 transition-colors"
        {...props}
      />
