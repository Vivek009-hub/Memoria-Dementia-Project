  ...
  return (
    <div className="py-16 px-6 max-w-6xl mx-auto space-y-16">
      ...
      <div className="text-center space-y-6 max-w-3xl mx-auto">
        <div className="inline-flex items-center space-x-2 px-4 py-1.5 bg-[#D8B24C]/10 border border-[#D8B24C]/30 rounded-full text-[#D8B24C] font-bold text-sm">
          <Shield className="w-4 h-4" />
          <span>AI-Powered Cognitive Care & Safety</span>
        </div>
        <h1 className="text-5xl md:text-6xl font-black text-[#F5F5F0] tracking-tight leading-tight">
          Empowering Care & Connection for Dementia Patients
        </h1>
        <p className="text-xl text-[#A7A7A2] font-medium">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card title="Cognitive Stimulation">
          <Brain className="w-10 h-10 text-[#D8B24C] mb-3" />
          <p className="text-[#A7A7A2] text-sm leading-relaxed">
        ...
        <Card title="Safety & Emergency Infrastructure">
          <ShieldAlert className="w-10 h-10 text-[#D95C5C] mb-3" />
          <p className="text-[#A7A7A2] text-sm leading-relaxed">
